export const zhCN = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "高级语音设置（ElevenLabs）",
    advancedVoiceSettingsDesc: "留空字段将使用提供商默认值。",
    vsStability: "稳定性（0–1）",
    vsSimilarityBoost: "相似度增强（0–1）",
    vsStyle: "风格夸张度（0–1）",
    vsSpeed: "速度（0.7–1.2）",
    vsSpeakerBoost: "说话人增强",
    vsDefaultPlaceholder: "默认",
    vsRange01: "必须介于 0 和 1 之间",
    vsRangeSpeed: "必须介于 0.7 和 1.2 之间",
    setupRequired: "需要配置",
