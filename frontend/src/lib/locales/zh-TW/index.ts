export const zhTW = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "進階語音設定（ElevenLabs）",
    advancedVoiceSettingsDesc: "欄位留空則使用提供商的預設值。",
    vsStability: "穩定性（0–1）",
    vsSimilarityBoost: "相似度增強（0–1）",
    vsStyle: "風格誇張度（0–1）",
    vsSpeed: "速度（0.7–1.2）",
    vsSpeakerBoost: "發言人增強",
    vsDefaultPlaceholder: "預設",
    vsRange01: "必須介於 0 到 1 之間",
    vsRangeSpeed: "必須介於 0.7 到 1.2 之間",
    setupRequired: "需要設定",
