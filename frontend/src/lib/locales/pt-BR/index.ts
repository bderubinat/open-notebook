export const ptBR = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "Configurações avançadas de voz (ElevenLabs)",
    advancedVoiceSettingsDesc: "Deixe um campo vazio para usar o padrão do provedor.",
    vsStability: "Estabilidade (0–1)",
    vsSimilarityBoost: "Reforço de similaridade (0–1)",
    vsStyle: "Exagero de estilo (0–1)",
    vsSpeed: "Velocidade (0.7–1.2)",
    vsSpeakerBoost: "Reforço do speaker",
    vsDefaultPlaceholder: "padrão",
    vsRange01: "Deve estar entre 0 e 1",
    vsRangeSpeed: "Deve estar entre 0.7 e 1.2",
