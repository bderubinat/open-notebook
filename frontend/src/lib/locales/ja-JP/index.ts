export const jaJP = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "詳細な音声設定（ElevenLabs）",
    advancedVoiceSettingsDesc: "空欄の場合はプロバイダーのデフォルトを使用します。",
    vsStability: "安定性（0–1）",
    vsSimilarityBoost: "類似度ブースト（0–1）",
    vsStyle: "スタイルの誇張（0–1）",
    vsSpeed: "速度（0.7–1.2）",
    vsSpeakerBoost: "スピーカーブースト",
    vsDefaultPlaceholder: "デフォルト",
    vsRange01: "0から1の間で入力してください",
    vsRangeSpeed: "0.7から1.2の間で入力してください",
    setupRequired: "設定が必要",
