export const itIT = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "Impostazioni vocali avanzate (ElevenLabs)",
    advancedVoiceSettingsDesc: "Lascia un campo vuoto per usare il valore predefinito del fornitore.",
    vsStability: "Stabilità (0–1)",
    vsSimilarityBoost: "Amplificazione della somiglianza (0–1)",
    vsStyle: "Esagerazione dello stile (0–1)",
    vsSpeed: "Velocità (0.7–1.2)",
    vsSpeakerBoost: "Amplificazione della voce",
    vsDefaultPlaceholder: "predefinito",
    vsRange01: "Deve essere compreso tra 0 e 1",
    vsRangeSpeed: "Deve essere compreso tra 0.7 e 1.2",
