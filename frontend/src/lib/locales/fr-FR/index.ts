export const frFR = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "Paramètres vocaux avancés (ElevenLabs)",
    advancedVoiceSettingsDesc: "Laissez un champ vide pour utiliser la valeur par défaut du fournisseur.",
    vsStability: "Stabilité (0–1)",
    vsSimilarityBoost: "Amplification de similarité (0–1)",
    vsStyle: "Exagération du style (0–1)",
    vsSpeed: "Vitesse (0.7–1.2)",
    vsSpeakerBoost: "Amplification de la voix",
    vsDefaultPlaceholder: "par défaut",
    vsRange01: "Doit être compris entre 0 et 1",
    vsRangeSpeed: "Doit être compris entre 0.7 et 1.2",
