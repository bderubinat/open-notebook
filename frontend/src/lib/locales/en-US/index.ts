export const enUS = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "Advanced voice settings (ElevenLabs)",
    advancedVoiceSettingsDesc: "Leave a field empty to use the provider default.",
    vsStability: "Stability (0–1)",
    vsSimilarityBoost: "Similarity boost (0–1)",
    vsStyle: "Style exaggeration (0–1)",
    vsSpeed: "Speed (0.7–1.2)",
    vsSpeakerBoost: "Speaker boost",
    vsDefaultPlaceholder: "default",
    vsRange01: "Must be between 0 and 1",
    vsRangeSpeed: "Must be between 0.7 and 1.2",
