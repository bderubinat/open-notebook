export const ruRU = {
  ...
  podcasts: {
    ...
    advancedVoiceSettings: "Расширенные настройки голоса (ElevenLabs)",
    advancedVoiceSettingsDesc: "Оставьте поле пустым, чтобы использовать значение провайдера по умолчанию.",
    vsStability: "Стабильность (0–1)",
    vsSimilarityBoost: "Усиление сходства (0–1)",
    vsStyle: "Преувеличение стиля (0–1)",
    vsSpeed: "Скорость (0.7–1.2)",
    vsSpeakerBoost: "Усиление говорящего",
    vsDefaultPlaceholder: "по умолчанию",
    vsRange01: "Должно быть от 0 до 1",
    vsRangeSpeed: "Должно быть от 0.7 до 1.2",
